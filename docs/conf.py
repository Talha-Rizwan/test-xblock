...
"""
myxblock-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'myxblock-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/myxblock-xblock",
...
#
# html_title = 'myxblock-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'My First XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'myxblock'),
                os.path.join(root_path, 'myxblock/migrations')])
