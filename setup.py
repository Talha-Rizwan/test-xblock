...
VERSION = get_version('myxblock', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""My First XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/myxblock-xblock',
    packages=find_packages(
        include=['myxblock', 'myxblock.*'],
        exclude=["*tests"],
    ),
